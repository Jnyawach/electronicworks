        ...
        <div class=" container ">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-5 mx-auto m-2">
                    ...
                    @auth()
                        @role('Client|Admin')
                        <a href="{{route('jobs.create')}}" title="Hire a writer" class="btn btn-primary hire" >Hire a
                            writer</a>
                        @endrole
                        @else
                        ...
                        @endauth
                    @auth()
                        <a href="{{route('project.index')}}" title="Sign up as freelancer" class="btn
                    btn-outline-primary free">Become a writer</a>
                        @else
        ...
        <div class="container mt-5 pt-5 choose">
            ...
            <div class="row mt-5">
                <div class="col-sm-11 col-md-3 col-lg-3 mx-auto text-center">
                    <img src="{{asset('images/badge.png')}}" class="img-fluid" alt="Quality Badge">
                ...
                <div class="col-sm-11 col-md-3 col-lg-3 mx-auto text-center">
                    <img src="{{asset('images/notebbok.png')}}" class="img-fluid" alt="Notebook">
                ...
                <div class="col-sm-11 col-md-3 col-lg-3 mx-auto text-center">
                    <img src="{{asset('images/clock.png')}}" class="img-fluid" alt="Clock">
                ...
                <div class="col-sm-11 col-md-3 col-lg-3 mx-auto text-center">
                    <img src="{{asset('images/finger-print.png')}}" class="img-fluid" alt="Finger Print">
        ...
        <div class="container mt-5 pt-5 join mb-5">
            <div class="row">
                <div class="col-sm-11 col-md-5 col-lg-5 mx-auto">
                    ...
                    <a href="{{route('registration.index')}}" class="btn btn-primary hire mt-3">Apply here <i class="fas fa-long-arrow-alt-right ml-3"></i></a>
                </div>
                <div class="col-sm-11 col-md-5 col-lg-6 mx-auto">
                    <img src="{{asset('images/Writers.png')}}" class="img-fluid" alt="Writers">
                </div>
        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="row mt-5">
                ...
                <div class="col-sm-11 col-md-3 col-lg-3">
                    ...
                    @endforeach
                    <div class="col-sm-11 col-md-3 col-lg-3">
                       <a href="{{route('field.index')}}" class="btn-link text-decoration-none more">Show more<i class="fas fa-long-arrow-alt-right ms-2"></i></a>
                    </div>
            </div>
        </div>
    </section>
