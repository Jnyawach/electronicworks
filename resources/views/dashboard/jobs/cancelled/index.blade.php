                        ...
                        <div class="row">
                            @if(isset($projects))
                                @foreach($projects as $project)
                                    <a href="{{route('cancelled.show',$project->slug)}}" class="text-decoration-none"
                                        ...
                                        <div class="col-sm-12 mx-auto">
                                            <div class="conte p-2">
                                                ...
                                                <h4 class="fs-6 fw-bold m-1"><span>Words:</span> {{$project->words}}&nbsp;&nbsp;
                                                    ...
                                                    <span>Status:</span> <span class="text-danger">{{$project->progress->name}}</span>
                                                </h4>
