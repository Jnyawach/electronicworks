                                        ...
                                        <form class="mt-5" enctype="multipart/form-data" action="{{route('task.store')
                                            ...
                                            <div class="form-group mt-4">
                                                ...
                                                <input class="form-control form-control-lg" id="materials"
                                                       type="file" multiple style="width: 400px" name="materials[]">
                                                <small class="text-danger">
                                                    @error('materials')
                                                    {{ $message }}
                                                    @enderror
                                                </small>
                                                <small>Please select multiple file at once if they exceed one.
                                            ...
                                            <div class="form-group required mt-4">
                                                <label for="deadline"  class="control-label">Deadline (date and time)
                                                    :</label><br>
                                                <input type="datetime-local" id="deadline" name="deadline"
                                                       class="complete" value="{{old('deadline')}}" required><br>
                                                <small class="text-danger">
                                                    @error('deadline')
                                                    {{ $message }}
                                                    @enderror
                                                </small>
                                                <small>Please provide deadline for the task</small>
                                            </div>
