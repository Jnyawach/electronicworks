                ...
                <div class="row">
                        ...
                        <div class="card shadow-sm">
                            <a href="#" class="text-decoration-none">
                                <div class="card-body p-4">
                                    <h4 class="fs-4 fw-bold">{{$users->count()}}</h4>
                                    <h5 class="fs-5">MANAGERS</h5>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 mx-auto text-center m-2">
                        <div class="card shadow-sm">
                            <a href="#" class="text-decoration-none">
                                <div class="card-body p-4">
                                    <h4 class="fs-4 fw-bold">{{$users->where('status',1)->count()}}</h4>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 mx-auto text-center m-2">
                        <div class="card shadow-sm">
                            <a href="#" class="text-decoration-none">
                                <div class="card-body p-4">
                                    <h4 class="fs-4 fw-bold">{{$users->count()-$users->where('status',1)->count()}}</h4>
                    ...
                    <div class="col-12 mx-auto">
                        <div class="card shadow-sm">
                                    ...
                                    @if($users->count()>0)
                                        @foreach($users as $writer)
                                            <tr>
                                                ...
                                                <td>@if($writer->isOnline())
                                                        <span class="text-success">online</span>
                                                        @else
                                                        {{\Carbon\Carbon::parse($writer->last_seen)->diffForHumans()}}
                                                        @endif
                                                </td>
                                                <td>
                                                    {{$writer->status->name}}
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="message1">
                                                            <li><a class="dropdown-item" href="{{route('administrator.show',
                                                        $writer->id)}}">View <i
                                                                        class="fas fa-external-link-square-alt
                                                                    ms-2"></i></a></li>
                                                            <li><a class="dropdown-item" href="{{route('administrator.edit',
                                                        $writer->id)}}">Edit <i
                                                            ...
                                                            <li>
                                                                <form method="POST" action="{{route('administrator.destroy',
                                                            $writer->id)}}">
                                                                    @method('DELETE')
                                                                    @csrf
                            ...
                            <div class="card-footer">
                                <a href="{{route('administrator.create')}}">Add Manager</a>
                            </div>
                        </div>
