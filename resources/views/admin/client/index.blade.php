                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="message1">
                                                            <li><a class="dropdown-item" href="{{route('client.show',
                                                        $client->id)}}">View <i
                                                                        class="fas fa-external-link-square-alt
                                                                    ms-2"></i></a></li>
                                                            <li><a class="dropdown-item" href="{{route('client.edit',
                                                        $client->id)}}">Edit <i
                                                                        class="fas fa-bookmark ms-2"></i></a></li>
                                                            <li>
                                                                @if($client->status->name=='Disabled')
