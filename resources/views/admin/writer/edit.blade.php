...
@section('content')
    <div class="dashboard-wrapper green-body pt-5">
        <div class="container p-5">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="m-4" method="POST" action="{{route('writer.update', $writer->id)}}"
                        ...
                        <div class="form-group row mt-3 required">
                            <div class="col-sm-11 col-md-5 col-lg-5 ">
                                ...
                                <input type="text" id="name" name="name" class="form-control complete"
                                       aria-describedby="name" required placeholder="First Name" value="{{$writer->name
                                       }}">
                            ...
                            <div class="col-sm-11 col-md-5 col-lg-5">
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-control complete"
                                       aria-describedby="last_name" required placeholder="Last Name"
                        ...
                        <div class="form-group row  required mt-3">
                            <div class="col-sm-12 col-md-6 col-lg-6 ">
                                ...
                                <input type="text" class="form-control complete " placeholder="Cellphone"
                                       aria-label="cellphone" name="cellphone" id="cellphone"
                                       value="{{$writer->cellphone}}">
                                <small class="text-danger">
                                    @error('cellphone')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 ">
                                ...
                                <input type="text" class="form-control complete"
                                       placeholder="Secondary cellphone" value="{{$writer->sec_cellphone}}"
                        ...
                        <div class="form-group row required mt-3 ">
                            <div class="col-sm-11 col-md-4 col-lg-4 ">
                                ...
                                <select class="form-select" aria-label="gender" id="gender" name="gender" required>
                                    <option selected value="{{$writer->detail->gender}}">{{$writer->detail->gender}}</option>
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4">
                                ...
                                <input type="text" id="language" class="form-control complete"
                                       aria-describedby="language" required value="{{$writer->detail->language}}"
                                       name="language">
                                <small class="text-danger">
                                    @error('language')
                                    {{ $message }}
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4">
                                ...
                                <select class="form-select" aria-label="night-calls" id="night-calls" required
                                        name="night_calls">
                                    <option selected value="{{$writer->detail->night_calls
                                        }}">{{$writer->detail->night_calls}}</option>
                        ...
                        <div class="form-group row required mt-3 ">
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4 mx-auto">
                                ...
                                <input type="text" id="city" class="form-control complete"
                                       aria-describedby="city" required name="city" value="{{$writer->detail->city}}">
                                <small class="text-danger">
                                    @error('city')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4 mx-auto">
                                ...
                                <input type="text" id="zip" class="form-control complete"
                                       aria-describedby="zip" required name="zip" value="{{$writer->detail->zip}}">
                                <small class="text-danger">
                                    @error('zip')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="form-group row required mt-3">
                            <div class="col-sm-11 col-md-5 col-lg-6 mx-auto">
                                ...
                                <input type="text" id="university" class="form-control complete"
                                       aria-describedby="university" required name="university"
                                       value="{{$writer->detail->university}}">
                                <small class="text-danger">
                                    @error('university')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-sm-11 col-md-5 col-lg-6 mx-auto">
                                ...
                                <input type="text" id="department" class="form-control complete"
                                       aria-describedby="department" required name="department"
                                       value="{{$writer->detail->department}}">
                                <small class="text-danger">
                                    @error('department')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="form-group row required mt-3">
                            <div class="col-sm-11 col-md-7 col-lg-6">
                                ...
                                <input type="text" id="course" class="form-control complete"
                                       aria-describedby="course" required name="course"
                                       value="{{$writer->detail->course}}">
                                <small class="text-danger">
                                    @error('course')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4">
                                ...
                                <input type="text" id="graduation" class="form-control complete"
                                       aria-describedby="graduation" required name="graduation"
                                       value="{{$writer->detail->graduation}}">
                                <small class="text-danger">
                                    @error('graduation')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="form-group row required mt-3">
                            ...
                            <div class="col-sm-11 col-md-4 col-lg-4">
                                ...
                                <input type="text" id="score" class="form-control complete"
                                       aria-describedby="score" required name="score"
                                       value="{{$writer->detail->score}}">
                                <small class="text-danger">
                                    @error('score')
                                    {{ $message }}
                                    @enderror
