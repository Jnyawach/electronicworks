                                ...
                                <div class="card-body">
                                    <table id="refund_table" class="display">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('manager-refund.show',$pending->id)}}" class="text-decoration-none text-success">Details</a> </td>
                                        </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
                                    ...
                                    <table id="all_refund_table" class="display">
                                        ...
                                        @foreach($refunds as $refund)
                                            <tr>
                                                ...
                                                <td>{{$refund->amount}}</td>
                                                <td><a href="{{route('manager-refund.show',$refund->id)}}" class="text-decoration-none text-success">Details</a> </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
