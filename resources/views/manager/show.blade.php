            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-7 col-lg-7 pt-5">
                    <div class="d-inline-flex">
                        <h5 class="fw-bold">{{$user->name}} &nbsp; {{$user->last_name}}</h5>
                        <!--action button-->
                        <a class="ms-5 mt-2  text-danger" href="{{route('manager.edit', $user->id)}}">Edit Profile<i
                                class="fas fa-bookmark ms-2"></i></a>
