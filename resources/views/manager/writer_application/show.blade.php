                    ...
                    <div class="writer-progress pt-5">
                        ...
                        @if($client->role->name=='Writer')
                            ...
                            <div>
                                ...
                                ('cert')->getUrl():'#'}}" class="m-2"
                                   target="_blank">Certificate:{{$client->detail->getFirstMedia('cert')
                                   ?$client->detail->getFirstMedia('cert')->name:'Certificate not provided'}}</a><br>
                                    <a href="{{$client->detail->getFirstMedia('identity')?$client->detail->getFirstMedia
                                ('identity')->getUrl():'#'}}" class="m-2"
                                       target="_blank">Certificate:{{$client->detail->getFirstMedia('identity')
