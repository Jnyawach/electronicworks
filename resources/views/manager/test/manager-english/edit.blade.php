...
@section('content')
    <div class="dashboard-wrapper green-body pt-5">
        <div class="container p-5">
            <section>
                <form action="{{route('manager-english.update', $exam->id)}}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="form-group">
                        <label for="category" class="control-label">Category:</label>
                        <select class="form-select complete" name="category_id" required id="category">
                            <option selected value="{{$exam->category->id}}">{{$exam->category->name}}</option>
                    ...
                    <div class="form-group row required">
                        <div class="col-12 mx-auto">
                            ...
                            <textarea class="form-control" id="exam" name="quiz">{!! $exam->quiz !!}</textarea>
                            <small class="text-danger">
                                @error('quiz')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row mt-3 required">
                        <div class="col-sm-11 col-md-6 col-lg-5  ">
                            ...
                            <textarea class="form-control" id="choice_a" name="choice_a">{!! $exam->choice_a
                            !!}</textarea>
                            <small class="text-danger">
                                @error('choice_a')
                                {{ $message }}
                        ...
                        <div class="col-sm-11 col-md-6 col-lg-6 ">
                            ...
                            <textarea class="form-control" id="choice_b" name="choice_b">{!! $exam->choice_b
                            !!}</textarea>
                            <small class="text-danger">
                                @error('choice_b')
                                {{ $message }}
                    ...
                    <div class="form-group required row">
                        <div class="col-sm-11 col-md-6 col-lg-6">
                            ...
                            <textarea class="form-control" id="choice_c" name="choice_c">{!! $exam->choice_c
                            !!}</textarea>
                            <small class="text-danger">
                                @error('choice_c')
                                {{ $message }}
                        ...
                        <div class="col-sm-11 col-md-6 col-lg-6">
                            ...
                            <textarea class="form-control" id="answer" name="answer">{!! $exam->answer !!}</textarea>
                            <small class="text-danger">
                                @error('answer')
                                {{ $message }}
                                @enderror
