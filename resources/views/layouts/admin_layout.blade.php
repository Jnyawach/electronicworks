                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('administrator.index')}}">Managers</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-28" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin-cancelled.index')}}">Cancelled</a>
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-39" class="collapse submenu">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin-refund.index')}}">Refunds
                                        </a>
                                    </li>
